...
| [029](029-commission-provenance-on-the-wire.md) | **Commission Provenance on the Wire** | Why provenance is emitted per walk rather than per earning, why the walk index is the correlation key, and why the outcome taxonomy has nine values |
